...
function loading() {
  return (
    ...
    <div className="px-4 py-12 mt-15">
      <div className="rounded relative">
        <div
          className="rounded-full bg-indigo-200 w-[190px] h-[190px] relative flex justify-center items-center mx-auto animate-spin"
        >
          <svg
          ...
          <div className="rounded-full bg-white w-[150px] h-[150px]"></div>
        </div>
        <p
          className="absolute mx-auto inset-x-0 my-auto inset-y-[80px] text-base font-medium text-gray-800 text-center"
        >
          Loading ...
        </p>
      </div>
